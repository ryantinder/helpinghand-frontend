// Generated by @wagmi/cli@0.1.5 on 2/19/2023 at 4:47:42 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * [__View Contract on Arbitrum One Arbiscan__](https://arbiscan.io/address/0xFC40A788787CC7D27Fb8888e5Dee08B4FfF1F341)
 */
...
export const projectFactoryAddress = {
  42161: '0xFC40A788787CC7D27Fb8888e5Dee08B4FfF1F341',
} as const
...
/**
 * [__View Contract on Arbitrum One Arbiscan__](https://arbiscan.io/address/0x77F155bAb80FC4941010f0dC758DB7613e9E2D91)
 */
...
export const identityProviderAddress = {
  42161: '0x77F155bAb80FC4941010f0dC758DB7613e9E2D91',
} as const
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link projectABI}__ and `functionName` set to `"removeParticipants"`.
 */
export function useProjectRemoveParticipants<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<
        ...
        >['abi'],
        'removeParticipants'
      > & { functionName?: 'removeParticipants' }
    : UseContractWriteConfig<TMode, typeof projectABI, 'removeParticipants'> & {
        abi?: never
        functionName?: 'removeParticipants'
      } = {} as any,
) {
  return useContractWrite<TMode, typeof projectABI, 'removeParticipants'>({
    abi: projectABI,
    functionName: 'removeParticipants',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link projectABI}__ and `functionName` set to `"removeParticipants"`.
 */
export function usePrepareProjectRemoveParticipants(
  config: Omit<
    UsePrepareContractWriteConfig<typeof projectABI, 'removeParticipants'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'removeParticipants',
    ...config,
  } as UsePrepareContractWriteConfig<typeof projectABI, 'removeParticipants'>)
}
